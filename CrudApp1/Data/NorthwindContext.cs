...
namespace CrudApp1.Models
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<CaptureDdlevent> CaptureDdlevents { get; set; } = null!;
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("server=localhost,1433;uid=sa;database=Northwind;pwd=your_password123;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CaptureDdlevent>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("CaptureDDLEvents");
            ...
            modelBuilder.Entity<City>(entity =>
            {
                ...
                entity.HasOne(d => d.Country)
                    ...
                    .HasConstraintName("FK__City__CountryId__1AD3FDA4");
            });
            ...
            modelBuilder.Entity<District>(entity =>
            {
                ...
                entity.HasOne(d => d.City)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__District__CityId__1EA48E88");

                entity.HasOne(d => d.Country)
                    .WithMany(p => p.Districts)
                    .HasForeignKey(d => d.CountryId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__District__Countr__1DB06A4F");
            });
            ...
            modelBuilder.Entity<Town>(entity =>
            {
                ...
                entity.HasOne(d => d.City)
                    .WithMany(p => p.Towns)
                    .HasForeignKey(d => d.CityId)
                    .HasConstraintName("FK__Town__CityId__22751F6C");

                entity.HasOne(d => d.Country)
                    .WithMany(p => p.Towns)
                    .HasForeignKey(d => d.CountryId)
                    .HasConstraintName("FK__Town__CountryId__2180FB33");

                entity.HasOne(d => d.District)
                    .WithMany(p => p.Towns)
                    .HasForeignKey(d => d.DistrictId)
                    .HasConstraintName("FK__Town__DistrictId__236943A5");
            });
